...
const CHANNEL_SECTIONS: ChannelSection[] = CHANNEL_CATEGORIES.map(category => ({
  id: category.id,
  title: category.title,
  channels: category.channels.slice(0, CHANNEL_PREVIEW_COUNT).map(mapChannel),
}));
...
const ExploreChannel = ({ onSeeAll, onPressBack }: ExploreChannelProps) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity style={styles.backButton} activeOpacity={0.7} onPress={onPressBack}>
          <Image source={{ uri: imgArrowLeft }} style={styles.backIcon} />
        </TouchableOpacity>
        <View style={styles.headerContent}>
          <View style={styles.headerTextContainer}>
            <Text style={styles.headerTitle}>Explore Channels</Text>
          </View>
        </View>
      </View>
        ...
        {CHANNEL_SECTIONS.map(section => (
          <View key={section.id} style={styles.sectionBlock}>
            <View style={styles.sectionHeader}>
              ...
              <TouchableOpacity
                style={styles.sectionCtaButton}
                activeOpacity={0.7}
                onPress={() => onSeeAll?.(section.id)}
              >
                <Text style={styles.sectionCtaText}>See all</Text>
              </TouchableOpacity>
            </View>
