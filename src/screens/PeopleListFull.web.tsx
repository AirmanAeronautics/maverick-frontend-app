...
const PeopleListFull = ({ title, people, onBack }: PeopleListFullProps) => {
  ...
  return (
    <div className="people-list-full-container">
      {/* Status Bar */}
      ...
      {/* Content */}
      <div className="scroll-view people-list-full-scroll">
