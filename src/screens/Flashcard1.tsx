...
const imgIconoirFlashSolid = require('../assets/iconoir_flash-solid.svg');
        ...
        <View style={styles.quiz1TitleSection}>
          <View style={styles.quiz1QuizIconContainer}>
            <View style={styles.quiz1QuizIconInner}>
              <Image source={imgIconoirFlashSolid} style={styles.quiz1QuizIconImage} />
            </View>
          </View>
          <View style={styles.quiz1TitleTextContainer}>
            <Text style={styles.quiz1Title}>Smart Cards</Text>
            <Text style={styles.quiz1Subtitle}>Reinforce what you've learned</Text>
          </View>
        </View>
