...
import imgIconoirFlashSolid from '../assets/iconoir_flash-solid.svg?url';
      ...
      <div className="quiz1-title-section">
        <div className="quiz1-quiz-icon-container">
          <div className="quiz1-quiz-icon-inner">
            <img alt="" src={imgIconoirFlashSolid} className="quiz1-quiz-icon-image quiz1-flash-icon" />
          </div>
        </div>
        <div className="quiz1-title-text-container">
          <p className="quiz1-title">Smart Cards</p>
          <p className="quiz1-subtitle">Reinforce what you've learned</p>
        </div>
      </div>
